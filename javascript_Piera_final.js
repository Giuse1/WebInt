...
function setTitle(n) {
    ...
    i = n-1;
    title.innerHTML = videoTitle[i]
    let numberVideo = document.getElementById("number");
    numberVideo.innerHTML = "playing video " + n.toString() + "/" +  videoUrl.length.toString();
}


// inserts the video in the jukebox player
function insertVideoJukebox(n) {
...
var videoUrl= ["https://ia800806.us.archive.org/3/items/feministelizabeth_gmail_De1/de1.mp4",
    "https://ia800905.us.archive.org/17/items/MindTheDoor_201502/DELETES/MindTheDoor.m4v",
    "https://ia800901.us.archive.org/33/items/classichollywood_mail_Xmas/Landis%20Christmas.mp4"];
...
canvas.width = 150;
canvas.height = 150;
var videoTitle = ["four jills in a jeep", "mind the door", "carole landis kay francis celebrate christmas"];
